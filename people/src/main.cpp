 ...
 *
 * Just: "${PATH_TO_BINARY}/people --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class people : public RoboComp::Application
{
public:
	people (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::people::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
